...
def charger_train(data_marchandises, train):
    while len(data_marchandises) > 0:
        ...
        place_min = 1000000
        index_place_min = 0
        for j in range(len(liste_place_dispo)):
            if liste_place_dispo[j][1] < place_min:
                place_min = liste_place_dispo[j][1]
                index_place_min = liste_place_dispo[j][0]
...
train_patrie = [[]]
train_patrie = charger_train(data_marchandises, train_patrie)
